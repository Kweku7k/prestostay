...
Revision ID: 60bba903dcff
Revises: a48672142a92
Create Date: 2023-08-17 13:33:36.744197
...
revision = '60bba903dcff'
down_revision = 'a48672142a92'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('listingId', sa.String(), nullable=True),
    ...
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('listingId', sa.String(), nullable=True),
    sa.Column('superListing', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
